 ...
 */
inline fun Grammar.brackets(left: String, right: String, crossinline p: Parser): Boolean = seq { word(left) && p() && word(right) }
 ...
 */
inline fun Grammar.angles(crossinline p: Parser): Boolean = brackets("<", ">", p)
 ...
 */
fun Grammar.angles(): Boolean = angles { true }
 ...
 */
inline fun Grammar.squares(crossinline p: Parser): Boolean = brackets("[", "]", p)
 ...
 */
fun Grammar.squares(): Boolean = squares { true }
 ...
 */
inline fun Grammar.curlies(crossinline p: Parser): Boolean = brackets("{", "}", p)
 ...
 */
fun Grammar.curlies(): Boolean = curlies { true }
 ...
 */
inline fun Grammar.parens(crossinline p: Parser): Boolean = brackets("(", ")", p)
 ...
 */
fun Grammar.parens(): Boolean = parens { true }
 ...
 */
inline fun Grammar.comma_list0(crossinline item: Parser): Boolean = around0(item) { word(",") }
 ...
 */
inline fun Grammar.comma_list1(crossinline item: Parser): Boolean = around1(item) { word(",") }
 ...
 */
inline fun Grammar.comma_list_term0(crossinline item: Parser): Boolean = list_term0(item) { word(",") }
 ...
 * An additional comma is allowed at the end.
 */
inline fun Grammar.comma_list_term1(crossinline item: Parser): Boolean = list_term1(item) { word(",") }
