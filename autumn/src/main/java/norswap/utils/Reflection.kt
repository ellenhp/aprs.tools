 ...
 */
infix fun Class<*>.supers(other: Class<*>): Boolean = this.isAssignableFrom(other)
 ...
 */
inline fun <reified T : Any> extends(other: Class<*>): Boolean = T::class.java extends other
 ...
 */
inline fun <reified T : Any> supers(other: Class<*>): Boolean = T::class.java supers other
